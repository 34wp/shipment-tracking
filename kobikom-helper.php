...
function shipment_tracking_get_kobikom_headers($api) {
...
function shipment_tracking_get_kobikom_balance($api) {
    $password= urlencode($api);
...
function shipment_tracking_SMS_gonder_kobikom($order_id) {
   ...
   $message = shipment_tracking_get_sms_template($order_id, get_option('shipment_tracking_sms_template'));
...
add_action('order_send_sms_kobikom', 'shipment_tracking_SMS_gonder_kobikom');
